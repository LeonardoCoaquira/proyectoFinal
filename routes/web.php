...
Route::post('/account/edit', [App\Http\Controllers\AccountController::class, 'changeName'])->name('changeName');
...
Route::get('/app/{route}', [App\Http\Controllers\PostController::class, 'showPictureApp']);
